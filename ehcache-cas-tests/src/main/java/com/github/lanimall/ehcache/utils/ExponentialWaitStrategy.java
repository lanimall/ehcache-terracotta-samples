 ...
 */
public class ExponentialWaitStrategy implements CasBackoffStrategy {
    private static final Logger logger = LoggerFactory.getLogger(ExponentialWaitStrategy.class);
    ...
    public ExponentialWaitStrategy(long base, long cap) {
        this(base, cap, DEFAULT_WAIT_USE_JITTER);
    }

    public ExponentialWaitStrategy(long base, long cap, boolean jitter) {
        this.base = base;
        this.cap = cap;
        this.jitter = jitter;
    }
