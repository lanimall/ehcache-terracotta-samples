...
public class SurveyResponseRestControllerTests {
    ...
    public void setup() throws Exception {
        ...
        this.surveyService.deleteAllSurveyResponsesAndAnswers();
        this.surveyService.deleteAllSurveysAndQuestions();

        //build the sample surveys with questions
        surveys = surveyService.addSurveysAndQuestions(2,10);

        //add some sample responses with answers
        surveyResponses = surveyService.addSurveyResponses(2);
    }
