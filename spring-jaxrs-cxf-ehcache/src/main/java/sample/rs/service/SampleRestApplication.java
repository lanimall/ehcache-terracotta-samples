...
import sample.rs.service.hello1.HelloServiceWithCacheImpl1;
import sample.rs.service.hello2.HelloServiceImpl2;
import sample.rs.service.hello2.HelloServiceWithCacheImpl2;
...
public class SampleRestApplication {
    ...
    public FactoryBean<CacheManager> cacheManager() {
        String ehcacheConfigPath = System.getProperty("ehcache.config.path", "classpath:ehcache4x.xml");
    ...
    public Server rsServer() {
        ...
        endpoint.setServiceBeans(Arrays.<Object>asList(
                ...
                new HelloServiceWithCacheImpl1(stringCache),
                new HelloServiceWithCacheImpl2(stringCache)));
        endpoint.setAddress("/");
