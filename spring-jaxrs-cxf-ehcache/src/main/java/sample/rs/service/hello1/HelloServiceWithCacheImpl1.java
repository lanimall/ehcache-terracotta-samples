...
@Path("/sayHelloWithCache")
@Api("/sayHelloWithCache")
public class HelloServiceWithCacheImpl1 implements HelloService {
    private static final String hello = "hello1";
    private Cache stringCache;

    public HelloServiceWithCacheImpl1(Cache stringCache) {
    ...
    public String sayHello(String a) {
        ...
        if(null == (cacheElem = stringCache.get(a))){
            isCacheHit = false;
            val = String.format("%s-%s (%s)" , (null == a)?"null":a, timeNow, hello);
